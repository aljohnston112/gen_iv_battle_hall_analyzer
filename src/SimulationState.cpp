...
PokemonState::PokemonState(CustomPokemon pokemon, const bool is_player):
    moves(pokemon.moves),
    types(pokemon.types),
...
[[nodiscard]] bool PokemonState::has_type(const PokemonType type) const {
    return types[0] == type || types[1] == type;
}

void PokemonState::change_type(const PokemonType type) {
    types[0] = type;
    types[1] = PokemonType::COUNT;
}

[[nodiscard]] std::vector<const MoveInfo*>& PokemonState::get_moves() {
    return moves;
}

void PokemonState::transform(const PokemonState& other) {
...
[[nodiscard]] Ability PokemonState::get_ability() const {
    return ability;
}

void PokemonState::set_ability(const Ability ability,
...
void PokemonState::clear_ability() {
    ability = Ability::Disabled;
}

[[nodiscard]] Item PokemonState::get_item_for_effect() const {
...
[[nodiscard]] Item PokemonState::get_item() const {
    return item;
}

bool PokemonState::try_set_item(const Item item) {
...
void PokemonState::try_apply_berry(const bool eaten) {
...
void PokemonState::eat_berry(const Item item) {
...
[[nodiscard]] int32_t PokemonState::get_health() const {
...
void PokemonState::heal(const int health_gained) {
...
[[nodiscard]] int32_t PokemonState::get_attack(const Weather weather) const {
...
[[nodiscard]] int32_t PokemonState::get_defense() const {
...
[[nodiscard]] int32_t PokemonState::get_special_attack(
...
[[nodiscard]] int32_t PokemonState::get_special_defense(
    const Weather weather) const {
...
[[nodiscard]] int32_t PokemonState::get_speed(const Weather weather) const {
...
void PokemonState::clear_negative_stat_changes() {
    int i = 0;
...
[[nodiscard]] double PokemonState::get_weight() const {
    return pounds;
}

[[nodiscard]] FieldLocation& PokemonState::get_field_location() {
    return field_location;
}

[[nodiscard]] Status PokemonState::get_status() const {
    return status;
}

void PokemonState::try_apply_status(
    const Status status,
...
void PokemonState::clear_status() {
    status = Status::NONE;
}

[[nodiscard]] bool PokemonState::is_confused() const {
    return confused;
}

void PokemonState::set_confused() {
    if (get_ability() != Ability::OwnTempo) {
        confused = true;
    }
}

[[nodiscard]] bool PokemonState::is_flinched() const {
    return flinched;
}

void PokemonState::set_flinched() {
    flinched = true;
}

void PokemonState::set_infatuated() {
    if (get_ability() != Ability::Oblivious) {
        infatuated = true;
    }
}

void PokemonState::set_was_hit() {
    was_hit_ = true;
}

[[nodiscard]] bool PokemonState::was_hit() const {
    return was_hit_;
}

[[nodiscard]] bool PokemonState::was_flash_fired() const {
    return this->flash_fired;
}

void PokemonState::set_flash_fire() {
    this->flash_fired = true;
}

[[nodiscard]] bool PokemonState::is_charging() const {
    return charging;
}

void PokemonState::start_charging() {
    charging = true;
}

void PokemonState::done_charging() {
    charging = false;
}

void PokemonState::used_move_that_requires_recharge() {
    recharging = true;
}

[[nodiscard]] bool PokemonState::is_recharging() const {
    return recharging;
}

void PokemonState::done_recharging() {
    recharging = false;
}

void PokemonState::increment_multi_turn_move_counter(const uint8_t max_turns) {
...
[[nodiscard]] int PokemonState::get_metronome_count() const {
    return metronome;
}

[[nodiscard]] bool PokemonState::is_protected() const {
    return protected_;
}

void PokemonState::break_protect() {
    protected_ = false;
}

[[nodiscard]] bool PokemonState::has_reflect_up() const {
    return reflect;
}

void PokemonState::break_reflect() {
    reflect = false;
}

[[nodiscard]] bool PokemonState::has_light_screen_up() const {
    return light_screen;
}

void PokemonState::break_light_screen() {
    light_screen = false;
}
...
[[nodiscard]] bool PokemonState::outspeeds(
...
int PokemonState::get_weather_ball_damage(
    PokemonState& defender_state,
...
[[nodiscard]] BestMove& PokemonState::get_chosen_move() {
    return chosen_move;
}

[[nodiscard]] BestMove& PokemonState::get_last_used_move() {
    return last_used_move;
}

void PokemonState::increase_metronome() {
    metronome++;
}

void PokemonState::clear_metronome() {
    metronome = 0;
}

void PokemonState::set_trapped_counter(const int turns) {
